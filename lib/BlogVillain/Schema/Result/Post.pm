...
__PACKAGE__->set_primary_key(qw/ category fulltitle /);
__PACKAGE__->add_unique_constraints( 
                post_ukey_fulltitle => ['fulltitle'] );
...
sub sqlt_deploy_hook {
	my ($self, $sqlt_table) = @_;
  	$sqlt_table->add_index(
        name=>'post_idx_fulltitle', fields=>['fulltitle'] );
  	$sqlt_table->add_index(
        name=>'post_idx_category', fields=>['category'] );
